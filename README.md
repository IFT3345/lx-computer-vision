...
# **Labo 4: Vision par ordinateur 

Dans cet exercice de laboratoire, nous verrons comment traiter les données capturées par la caméra afin de construire un contrôleur réactif de base pour notre Duckiebot.
...
Chaque caméra étant potentiellement fabriquée différemment et montée à un endroit légèrement différent sur le robot, il sera nécessaire de la calibrer. Cette opération comprendra deux parties :
...
Vous pouvez maintenant passer au [premier cahier](./notebooks/01-Pinhole-Camera/pinhole_camera_matrix.ipynb).

# Crédits

Cet exercice a été initialement développé par [Andrea Daniele](https://afdaniele.com/) et [Matthew Walter](https://home.ttic.edu/~mwalter/).
